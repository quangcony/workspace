...
const ListWorkingStatuss = ({
  ...
  const columns = [
    ...
    {
      title: `${i18n.t("setting.workingStatus.lstName")}`,
      dataIndex: "NAME",
      width: "15%",
  ...
  const { confirm } = useConfirmDelete(
    handleDelete,
    "Are you sure delete this working status?"
  );
...
export default ListWorkingStatuss;
