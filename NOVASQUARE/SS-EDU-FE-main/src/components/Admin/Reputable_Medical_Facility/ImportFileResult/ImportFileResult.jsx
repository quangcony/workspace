    ...
    <div>
      <form>
        <Row>
          <Col span={8}>
            <p>
              Chọn danh sách cơ sở khám cần tải lên. <br />
      ...
      <div style={{ marginTop: 15 }}>
        ...
        <div>
          <p style={styleText}>
            <span>Số cơ sở khám chữa bệnh được import</span>
      ...
      <div style={{ marginTop: 20 }}>
        ...
        {/* {!verifySuccess ? (
          <Table pagination={TblPagination} columns={columns} dataSource={data} onChange={onChange} />
        ) : (
