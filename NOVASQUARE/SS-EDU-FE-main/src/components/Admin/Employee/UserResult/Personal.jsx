        ...
        <Row>
          ...
          >
            ...
            >
              ...
              <Form.Item name="GENDER" label={i18n.t("hr.gender")}>
                <Input disabled />
              </Form.Item>
              <Form.Item name="BOD" label={i18n.t("hr.birth")}>
                <Input disabled />
              </Form.Item>
              <Form.Item
                name="PLACE_OF_BIRTH"
              ...
              <Form.Item name="DOMICILE" label={i18n.t("hr.domicile")}>
                <Input disabled />
              </Form.Item>
              <Form.Item name="RESIDENT" label={i18n.t("hr.resident")}>
                <Input disabled />
              </Form.Item>
              <Row>
                <Col span={8}>
              ...
              <Form.Item name="EMAIL" label={i18n.t("hr.email")}>
                <Input disabled />
              </Form.Item>
              <Row>
                <Col span={12}>
