...
const FrmSubclinicalExamination = ({
  ...
  const handleOk = () => {
    ...
    const glucoseData = {
      ...
      GLUCOSE_HUNGRY_REFERENCE_MIN: newData?.GLUCOSE_MIN,
      GLUCOSE_HUNGRY_REFERENCE_MAX: newData?.GLUCOSE_MAX,
    };
    ...
    const ureCreatineData = {
      UREA_DEFAULT_UNIT: newData?.UREA_UNIT_DEFAULT,
      CREATINE_DEFAULT_UNIT: newData?.CREATINE_UNIT_DEFAULT,

      UREA_RESULT: UREA_RESULT,
      UREA_REFERENCE_MIN: newData?.UREA_MIN,
      UREA_REFERENCE_MAX: newData?.UREA_MAX,

      CREATINE_RESULT: CREATINE_RESULT,
      CREATINE_REFERENCE_MIN: newData?.CREATINE_MIN,
      CREATINE_REFERENCE_MAX: newData?.CREATINE_MAX,
    };

    const bloodLipidData = {
      CHOLESTEROL_DEFAULT_UNIT: newData?.CHOLESTEROL_UNIT_DEFAULT,
      HDL_DEFAULT_UNIT: newData?.HDL_UNIT_DEFAULT,
      LDL_DEFAULT_UNIT: newData?.LDL_UNIT_DEFAULT,
      TRIGLYCERIDE_DEFAULT_UNIT: newData?.TRIGLYCERIDE_UNIT_DEFAULT,

      CHOLESTEROL_RESULT: CHOLESTEROL_RESULT,
      CHOLESTEROL_REFERENCE_MIN: newData?.CHOLESTEROL_MIN,
      CHOLESTEROL_REFERENCE_MAX: newData?.CHOLESTEROL_MAX,

      HDL_RESULT: HDL_RESULT,
      HDL_REFERENCE_MIN: newData?.HDL_MIN,
      HDL_REFERENCE_MAX: newData?.HDL_MAX,

      LDL_RESULT: LDL_RESULT,
      LDL_REFERENCE_MAX: newData?.LDL_MAX,
      LDL_REFERENCE_MIN: newData?.LDL_MIN,

      TRIGLYCERIDE_RESULT: TRIGLYCERIDE_RESULT,
      TRIGLYCERIDE_REFERENCE_MAX: newData?.TRIGLYCERIDE_MAX,
      TRIGLYCERIDE_REFERENCE_MIN: newData?.TRIGLYCERIDE_MIN,
    };
