...
const RecruitMedicalExaminationExcelImportDetails = ({
  onCancel,
  dataViewPDF,
}) => {
          ...
          <Col span={22} offset={1}>
            <Space wrap style={useStyles.setCenter} className="title">
              <Typography.Title level={3}>
                KẾT QUẢ KHÁM SỨC KHỎE TUYỂN DỤNG
              </Typography.Title>
            </Space>
                ...
                <Row>
                  <Col span={12}>
                    <Space className="m0-p0">
                      ...
                      >
                        {dataViewPDF.FIRST_NAME && dataViewPDF.LAST_NAME
                          ? dataViewPDF.LAST_NAME + " " + dataViewPDF.FIRST_NAME
                          : ""}
                      </Typography.Paragraph>
                    </Space>
                  </Col>
        ...
        <Row>
          <Col span={22} offset={1}>
            <Space direction="vertical" size={4} className="title">
              ...
              >
                {dataViewPDF.NEXT_PHENOMENON ? dataViewPDF.NEXT_PHENOMENON : ""}
              </Typography.Paragraph>
              {/* </Space> */}
              {/* <Space className="m0-p0"> */}
              <Typography.Title
...
export default RecruitMedicalExaminationExcelImportDetails;
