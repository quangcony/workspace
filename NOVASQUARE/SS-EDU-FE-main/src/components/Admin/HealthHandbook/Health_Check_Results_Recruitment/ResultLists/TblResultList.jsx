...
const TblResultList = ({
            ...
            <>
              <Space size="middle">
                ...
                <Button
                  ...
                  disabled={
                    (isDoctor &&
                      record?.Physical_Exam_Results[0]?.STATUS === 5) ||
                    (isDoctor && record?.Physical_Exam_Results[0]?.STATUS === 0)
                      ? true
                      : false
                  }
                />
  ...
  useEffect(() => {
    if (listPhysicalExam) {
      var newLists = listPhysicalExam.reduceRight(function (previous, current) {
