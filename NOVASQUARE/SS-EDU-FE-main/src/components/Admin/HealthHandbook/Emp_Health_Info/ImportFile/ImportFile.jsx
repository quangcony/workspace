...
const ImportFileResult = ({ examType, onCancel, isOpen }) => {
  ...
  const [physicalExamOptionHardToxic, setPhysicalExamOptionHardToxic] =
    useRecoilState(physicalExamOptionStateHardToxic);
  ...
  const handleUploadFinal = async (e) => {
    ...
    try {
      ...
      switch (examType) {
        case 4:
        case 5:
          formDataFinal.append("examType", examType);
        ...
        try {
          ...
          if (res.data) {
            switch (examType) {
              ...
              case 5:
                physicalExamByQueryData(
                  physicalExamOptionHardToxic,
                  setPhysicalExamOptionHardToxic,
                  {
                    INPUT_STATUS: 1,
                    TYPE: examType,
                  },
    ...
    <div>
      <form>
        <Row>
          <Col span={8}>
            <p>
              Chọn danh sách kết quả KSK cần tải lên. <br />
      ...
      <div style={{ marginTop: 15 }}>
        <div style={{ display: "flex" }}>
          <h5 style={{ marginRight: 50 }}>
            ...
            >
              Bấm vào đây để tải kết quả kiểm tra
            </span>
          </h5>
