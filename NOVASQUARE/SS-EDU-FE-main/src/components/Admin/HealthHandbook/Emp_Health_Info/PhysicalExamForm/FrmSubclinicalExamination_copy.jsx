...
const FrmSubclinicalExamination = ({
  ...
  useEffect(() => {
    if (generalSetting) {
      ...
      setUnitCanxi(generalSetting?.BLOOD_CALCIUM_UNIT_DEFAULT);
  ...
  const handleOk = () => {
    ...
    const result = {
      ...data,
      BLOOD_CALCIUM_RESULT:
        unitCanxi === "mg/dL" || unitCanxi === "mg/dl"
          ? (Number(newData?.BLOOD_CALCIUM_RESULT) / 18).toFixed(1)
          : newData?.BLOOD_CALCIUM_RESULT,
      BLOOD_CALCIUM_MIN:
        unitCanxi === "mg/dL" || unitCanxi === "mg/dl"
          ? (Number(newData?.BLOOD_CALCIUM_MIN) / 18).toFixed(1)
          : Number(newData?.BLOOD_CALCIUM_MIN),
      BLOOD_CALCIUM_MAX:
        unitCanxi === "mg/dL" || unitCanxi === "mg/dl"
          ? (Number(newData?.BLOOD_CALCIUM_MAX) / 18).toFixed(1)
          : Number(newData?.BLOOD_CALCIUM_MAX),
    };
    ...
    const glucoseData = {
      ...
      GLUCOSE_HUNGRY_REFERENCE_MIN:
        unitGlucose === "mg/dL" || unitGlucose === "mg/dl"
          ? (Number(newData?.GLUCOSE_HUNGRY_REFERENCE_MIN) * 0.055).toFixed(1)
          : Number(newData?.GLUCOSE_HUNGRY_REFERENCE_MIN),
      GLUCOSE_HUNGRY_REFERENCE_MAX:
        unitGlucose === "mg/dL" || unitGlucose === "mg/dl"
          ? (Number(newData?.GLUCOSE_HUNGRY_REFERENCE_MAX) * 0.055).toFixed(1)
          : Number(newData?.GLUCOSE_HUNGRY_REFERENCE_MAX),
    };
    ...
    const ureCreatineData = {
      ...
      UREA_REFERENCE_MAX:
        unitUrea === "mg/dL" || unitUrea === "mg/dl"
          ? (Number(newData?.UREA_REFERENCE_MAX) * 0.166).toFixed(1)
          : Number(newData?.UREA_REFERENCE_MAX),
      UREA_REFERENCE_MIN:
        unitUrea === "mg/dL" || unitUrea === "mg/dl"
          ? (Number(newData?.UREA_REFERENCE_MIN) * 0.166).toFixed(1)
          : Number(newData?.UREA_REFERENCE_MIN),
      ...
      CREATINE_REFERENCE_MAX:
        unitCreatinin === "mg/dL" || unitCreatinin === "mg/dl"
          ? (Number(newData?.CREATINE_REFERENCE_MAX) * 88.4).toFixed()
          : Number(newData?.CREATINE_REFERENCE_MAX),
      CREATINE_REFERENCE_MIN:
        unitCreatinin === "mg/dL" || unitCreatinin === "mg/dl"
          ? (Number(newData?.CREATINE_REFERENCE_MIN) * 88.4).toFixed()
          : Number(newData?.CREATINE_REFERENCE_MIN),
    };
    ...
    const bloodLipidData = {
      ...
      CHOLESTEROL_REFERENCE_MAX:
        unitCholesterol === "mg/dL" || unitCholesterol === "mg/dl"
          ? (Number(newData?.CHOLESTEROL_REFERENCE_MAX) * 0.02586).toFixed(1)
          : Number(newData?.CHOLESTEROL_REFERENCE_MAX),
      CHOLESTEROL_REFERENCE_MIN:
        unitCholesterol === "mg/dL" || unitCholesterol === "mg/dl"
          ? (Number(newData?.CHOLESTEROL_REFERENCE_MIN) ** 0.02586).toFixed(1)
          : Number(newData?.CHOLESTEROL_REFERENCE_MIN),
      ...
      HDL_REFERENCE_MAX:
        unitHDL === "mg/dL" || unitHDL === "mg/dl"
          ? (Number(newData?.HDL_REFERENCE_MAX) * 0.0259).toFixed(1)
          : Number(newData?.HDL_REFERENCE_MAX),
      HDL_REFERENCE_MIN:
        unitHDL === "mg/dL" || unitHDL === "mg/dl"
          ? (Number(newData?.HDL_REFERENCE_MIN) * 0.0259).toFixed(1)
          : Number(newData?.HDL_REFERENCE_MIN),
      ...
      LDL_REFERENCE_MAX:
        unitLDL === "mg/dL" || unitLDL === "mg/dl"
          ? (Number(newData?.LDL_REFERENCE_MAX) * 0.0259).toFixed(1)
          : Number(newData?.LDL_REFERENCE_MAX),
      LDL_REFERENCE_MIN:
        unitLDL === "mg/dL" || unitLDL === "mg/dl"
          ? (Number(newData?.LDL_REFERENCE_MIN) * 0.0259).toFixed(1)
          : Number(newData?.LDL_REFERENCE_MIN),
      ...
      TRIGLYCERIDE_REFERENCE_MAX:
        unitTrigly === "mg/dL" || unitTrigly === "mg/dl"
          ? (Number(newData?.TRIGLYCERIDE_REFERENCE_MAX) * 0.01126).toFixed(1)
          : Number(newData?.TRIGLYCERIDE_REFERENCE_MAX),
      TRIGLYCERIDE_REFERENCE_MIN:
        unitTrigly === "mg/dL" || unitTrigly === "mg/dl"
          ? (Number(newData?.TRIGLYCERIDE_REFERENCE_MIN) * 0.01126).toFixed(1)
          : Number(newData?.TRIGLYCERIDE_REFERENCE_MIN),
    };
  ...
  const handleUnitGlucose = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        ...
        GLUCOSE_HUNGRY_REFERENCE_MIN: unit2,
        GLUCOSE_HUNGRY_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        ...
        GLUCOSE_HUNGRY_REFERENCE_MIN: unit5,
        GLUCOSE_HUNGRY_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitUre = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        UREA_RESULT: unit1,
        UREA_REFERENCE_MIN: unit2,
        UREA_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        UREA_RESULT: unit4,
        UREA_REFERENCE_MIN: unit5,
        UREA_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitCreatinin = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        ...
        CREATINE_REFERENCE_MIN: unit2,
        CREATINE_REFERENCE_MAX: unit3,
      });
    }
    if (value === "µmol/L" || value === "µmol/l") {
      ...
      form.setFieldsValue({
        ...
        CREATINE_REFERENCE_MIN: unit5,
        CREATINE_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitCholesterol = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        ...
        CHOLESTEROL_REFERENCE_MIN: unit2,
        CHOLESTEROL_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        ...
        CHOLESTEROL_REFERENCE_MIN: unit5,
        CHOLESTEROL_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitHDL = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        HDL_RESULT: unit1,
        HDL_REFERENCE_MIN: unit2,
        HDL_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        HDL_RESULT: unit4,
        HDL_REFERENCE_MIN: unit5,
        HDL_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitLDL = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        LDL_RESULT: unit1,
        LDL_REFERENCE_MIN: unit2,
        LDL_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        LDL_RESULT: unit4,
        LDL_REFERENCE_MIN: unit5,
        LDL_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitTrigly = (value) => {
    ...
    if (value === "mg/dL" || value === "mg/dl") {
      ...
      form.setFieldsValue({
        ...
        TRIGLYCERIDE_REFERENCE_MIN: unit2,
        TRIGLYCERIDE_REFERENCE_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      ...
      form.setFieldsValue({
        ...
        TRIGLYCERIDE_REFERENCE_MIN: unit5,
        TRIGLYCERIDE_REFERENCE_MAX: unit6,
      });
    }
  };
  ...
  const handleUnitCanxi = (value) => {
    setUnitCanxi(value);
    if (value === "mg/dL" || value === "mg/dl") {
      const unit1 = BloodCanxi ? (BloodCanxi * 18).toFixed(1) : null;
      const unit2 = CanxiMin ? (CanxiMin * 18).toFixed(1) : null;
      const unit3 = CanxiMax ? (CanxiMax * 18).toFixed(1) : null;
      setBloodCanxi(Number(unit1));
      setCanxiMin(Number(unit2));
      setCanxiMax(Number(unit3));
      form.setFieldsValue({
        BLOOD_CALCIUM_RESULT: unit1,
        BLOOD_CALCIUM_MIN: unit2,
        BLOOD_CALCIUM_MAX: unit3,
      });
    }
    if (value === "mmol/L" || value === "mmol/l") {
      const unit4 = BloodCanxi ? (BloodCanxi / 18).toFixed(2) : null;
      const unit5 = CanxiMin ? (CanxiMin / 18).toFixed(2) : null;
      const unit6 = CanxiMax ? (CanxiMax / 18).toFixed(2) : null;
      setBloodCanxi(Number(unit4));
      setCanxiMin(Number(unit5));
      setCanxiMax(Number(unit6));
      form.setFieldsValue({
        BLOOD_CALCIUM_RESULT: unit4,
        BLOOD_CALCIUM_MIN: unit5,
        BLOOD_CALCIUM_MAX: unit6,
      });
    }
  };
