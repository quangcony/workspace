...
const OccupationalMedicalExamPDF = ({ onCancel, isOpen, setDownloadPdf, downloadPdf }) => {
  const [employeeId, setEmployeeId] = useRecoilState(employeeIdState);
  const [physicalExamId, setPhysicalExamId] =
    useRecoilState(physicalExamIdState);
  ...
  }, [employeeId, physicalExamId, isOpen])
  ...
  useEffect(() => {
    if (downloadPdf && employee && physicalExam) {
      setTimeout(() => {
        handleDownloadPDF();
      }, 500);
    }
              ...
              <Col span={22} offset={1}>
                <Space style={useStyles.setCenter} wrap>
                  <Typography.Title level={3}>
                    KẾT QUẢ KHÁM SỨC KHỎE BỆNH NGHỀ NGHIỆP
                  </Typography.Title>
                </Space>
              </Col>
              <Col span={22} offset={1}>
                      ...
                      <Col span={12}>
                        <Space style={{ padding: 0 }}>
                          ...
                          <Typography.Paragraph
                            ...
                            strong
                          >
                            {specialExam && specialExam[0]?.TYPE
                              ? "ĐỊNH KỲ"
                              : "TẦM SOÁT"}
                          </Typography.Paragraph>
                        </Space>
                      ...
                      <Col span={12}>
                        <Space style={{ padding: 0 }}>
                          ...
                          <Typography.Paragraph
                            ...
                            strong
                          >
                            {moment(new Date(employee?.User?.BOD)).format(
                              formatDate.Type
                            )}
                          </Typography.Paragraph>
                        </Space>
                    ...
                    <Row>
                      ...
                      <Col span={12}>
                        <Space style={{ padding: 0 }}>
                          ...
                          >
                            {specialExam &&
                              specialExam[0]?.DEPARTMENT_WORKED_YEAR}
                          </Typography.Paragraph>
                        </Space>
                      </Col>
                    </Row>
