...
const ImportHistory = () => {
  ...
  const columns = [
    ...
    {
      title: i18n.t("healthHandbooks.employeeHealthInfo.medicalType"),
      dataIndex: "MEDICAL_TYPE",
      width: "20%",
      sorter: (a, b) => ("" + a.MEDICAL_TYPE).localeCompare(b.MEDICAL_TYPE),
    },
    {
      title: i18n.t("healthHandbooks.employeeHealthInfo.specialDisease"),
      dataIndex: "DISEASE",
      width: "40%",
