...
const MutationPreClinicalDefault = ({
  title = "",
  isOpen,
  onOk,
  onCancel,
  ...
  const handleOk = () => {
    ...
    if (preclinicaldefault) {
      return onUpdate(form.getFieldValue(), preclinicaldefault.id, () =>
        handleCancel()
      );
    }
  ...
  const onFinish = (values) => {
    if (preclinicaldefault) {
      return onUpdate(values, preclinicaldefault.id, () => handleCancel());
    }
  ...
  useEffect(() => {
    form.setFieldsValue(preclinicaldefault);
  }, [preclinicaldefault, form]);
...
export default MutationPreClinicalDefault;
