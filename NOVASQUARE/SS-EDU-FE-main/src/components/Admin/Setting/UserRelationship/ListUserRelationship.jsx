...
const ListUserRelationship = ({
  ...
  const columns = [
    ...
    {
      title: `${i18n.t("setting.userRelationships.userRelaName")}`,
      dataIndex: "NAME",
      sorter: (a, b) => ("" + a.NAME).localeCompare(b.NAME),
    },

    {
      title: `${i18n.t("setting.userRelationships.desc")}`,
      dataIndex: "DESC",
    },

    {
      title: `${i18n.t("setting.userRelationships.note")}`,
      dataIndex: "NOTE",
    },
    {
