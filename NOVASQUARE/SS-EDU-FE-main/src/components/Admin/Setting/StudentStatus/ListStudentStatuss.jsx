...
const ListStudentStatuss = ({
  ...
  const columns = [
    ...
    {
      title: `${i18n.t("setting.studentStatus.lstName")}`,
      dataIndex: "NAME",
      width: "15%",
  ...
  const { confirm } = useConfirmDelete(
    handleDelete,
    "Are you sure delete this student status?"
  );
...
export default ListStudentStatuss;
